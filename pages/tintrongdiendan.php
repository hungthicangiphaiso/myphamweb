...
$laythoaluan=laythoaluanvande($idthoaluan);
...
?>
<?php
$laytongsobinhluan=laybinhluanchovande($idthoaluan);
...
{
?>
<a href="index.php?p=tintrongdiendan&idthoaluan=<?php echo $rowlaythoaluan["idthoaluan"]?>&trangthoa=<?php echo $i?>" id="khongco"><?php echo $i?></a>
<?php
}
?>
<?php
$laytungnguoibinhluan=phantrangtrongvande($trangthoa,$sotin,$idthoaluan);
...
?>
   ...
   <p class="noidunglay"><?php echo $rowlaytungnguoibinh["noidung"]?></p>
   <div id="clear"></div>
   <img src="hinh/line_center.png"/>
<?php
}
?>
