...
{
?>
<h3 id="tieudechinh">Chào Mừng bạn tới diễn đàn Hóa ở hocladau.vn</h3>
<p style="color:#8c9d9d">Ở đâu bạn sẽ được trao đổi và giải đáp mọi thắc mắc về Hóa trong đề thi đại học.</p>
<form name="form1" method="post" action="index.php?p=diendan">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
    ...
    <tr>
      <td ></td>
      <td>
      <input name="btnbinhluanhoa" type="submit" id="btnbinhluan" value="Gởi"></td>
    </tr>
  </table>
</form>
<?php
